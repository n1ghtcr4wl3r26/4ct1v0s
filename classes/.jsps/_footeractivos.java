  /*@lineinfo:filename=/footeractivos.jsp*/
...
public class _footeractivos extends oracle.jsp.runtime.HttpJsp {
    ...
    */
    ...
    try {
      ...
      /*@lineinfo:translated-code*//*@lineinfo:7^11*/      {
        ...
        __jsp_taghandler_1.setHref("activos.do");
        ...
        if (OracleJspRuntime.checkStartBodyTagEval(__jsp_tag_starteval))
        {
          ...
          /*@lineinfo:translated-code*//*@lineinfo:7^57*/          } while (__jsp_taghandler_1.doAfterBody()==javax.servlet.jsp.tagext.BodyTag.EVAL_BODY_AGAIN);
