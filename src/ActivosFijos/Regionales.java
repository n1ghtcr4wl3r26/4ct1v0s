...
public class Regionales extends Action 
{
  /**
  ...
  public ActionForward execute(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response) throws IOException, ServletException
  {
    ...
    RegionalesForm opform = (RegionalesForm) form;
    ...
    try {
       ...
       ArrayList aCalm = bdc.listarRegionales(1);
       request.setAttribute("RegionalesLista", aCalm);
       ArrayList aCalm1 = bdc.listarFuncionarios4(0,opform.getReg_codigo());
    ...
    return mapping.findForward("regionales");
  }
}