...
public class Tiposbaja extends Action 
{
  /**
  ...
  public ActionForward execute(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response) throws IOException, ServletException
  {
    ...
    TiposbajaForm opform = (TiposbajaForm) form;
    ...
    try {
       ...
       ArrayList aCalm = bdc.listarTiposbaja(1);
       ...
       error.add("error", new ActionMessage("errordb", "No se pudo iniciar Tiposbaja"));
       error.add("error", new ActionMessage("errordb", e.toString() ));
       e.printStackTrace();
       saveErrors( request, error );
    }
    }
    return mapping.findForward("tiposbaja");
  }
}