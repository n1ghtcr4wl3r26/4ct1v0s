...
public class Proyectos extends Action 
{
  /**
  ...
  public ActionForward execute(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response) throws IOException, ServletException
  {
    ...
    ProyectosForm opform = (ProyectosForm) form;
    ...
    try {
       ...
       ArrayList aCalm = bdc.listarProyectos2(1);
       request.setAttribute("ProyectosLista", aCalm);
       ArrayList aCalm2 = bdc.listarFinanciadores(0);
       request.setAttribute("FinanciadoresLista", aCalm2);
