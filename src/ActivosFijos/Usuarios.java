...
public class Usuarios extends Action 
{
  /**
  ...
  public ActionForward execute(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response) throws IOException, ServletException
  {
    ...
    UsuariosForm opform = (UsuariosForm) form;
    ...
    try {
       ...
       ArrayList aCalm = bdc.listarUsuarios(1);
       request.setAttribute("UsuariosLista", aCalm);
       ArrayList aCalm1 = bdc.listarFuncionarios(0,fInicio.getCod_reg());
