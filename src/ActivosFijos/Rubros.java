...
public class Rubros extends Action 
{
  /**
  ...
  public ActionForward execute(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response) throws IOException, ServletException
  {
    ...
    RubrosForm opform = (RubrosForm) form;
    ...
    try {
       ...
       ArrayList aCalm = bdc.listarRubros(1);
       request.setAttribute("RubrosLista", aCalm);
       ArrayList aCalm2 = bdc.listarPartidas(0);
    ...
    return mapping.findForward("rubros");
  }
}