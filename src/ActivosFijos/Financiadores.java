...
public class Financiadores extends Action 
{
  /**
  ...
  public ActionForward execute(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response) throws IOException, ServletException
  {
    ...
    FinanciadoresForm opform = (FinanciadoresForm) form;
    ...
    try {
       ...
       ArrayList aCalm = bdc.listarFinanciadores(1);
    ...
    return mapping.findForward("financiadores");
  }
}