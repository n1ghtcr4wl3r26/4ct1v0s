...
public class Tipocambio extends Action 
{
  /**
  ...
  public ActionForward execute(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response) throws IOException, ServletException
  {
    ...
    TipocambioForm opform = (TipocambioForm) form;
    ArrayList aCalm;
    ...
    try {
       ...
       if ((mapping.getParameter().equals("rep"))||(mapping.getParameter().equals("ins"))||(mapping.getParameter().equals("rpt")))
          aCalm = bdc.listarTipocambio(1,4);
       else
          aCalm = bdc.listarTipocambio(1,0);
       ...
       error.add("error", new ActionMessage("errordb", "No se pudo iniciar Tipocambio"));
       error.add("error", new ActionMessage("errordb", e.toString() ));
       e.printStackTrace();
       saveErrors( request, error );
    }
    }
    return mapping.findForward("tipocambio");
  }
}