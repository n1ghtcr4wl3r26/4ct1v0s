...
public class Tiposdoc extends Action 
{
  /**
  ...
  public ActionForward execute(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response) throws IOException, ServletException
  {
    ...
    TiposdocForm opform = (TiposdocForm) form;
    ...
    try {
       ...
       ArrayList aCalm = bdc.listarTiposdoc(1,0,codreg,codreg);
       ...
       error.add("error", new ActionMessage("errordb", "No se pudo iniciar Tiposdoc"));
       error.add("error", new ActionMessage("errordb", e.toString() ));
       e.printStackTrace();
       saveErrors( request, error );
    }
    }
    return mapping.findForward("tiposdoc");
  }
}