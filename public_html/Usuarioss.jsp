...
<script language="JavaScript" type="text/JavaScript">
  function validar(form)
  {
    ...
    try {
    if (!textoObligatorio( form.usu_descripcion.value )) {
	   	mensaje=mensaje+"Debe introducir Descripción\n"
		  if (foco.length==0) foco="form.usu_descripcion.focus()"
    }
    }
    catch (e) {
      xvar=0
...
<logic:equal value="1" name="UsuariosForm" property="operacion">
   <logic:equal name="UsuariosForm" property = "opcion" value="1" >
      <tr>
          ...
          <td><html:text property="usu_codigo" name="UsuariosForm" size="2" maxlength="2" /></td>
      </tr>
      <tr>
      ...
      <tr>
          <td align="right"><html:submit value="Insertar" styleClass="boton1" property="boton" onclick="operacion.value=2;opcion.value=1" />
          <td align="left"><html:submit value="Cancelar" styleClass="boton1" property="boton" onclick="operacion.value=2;opcion.value=9" />
      </tr>
   </logic:equal>
   <logic:equal name="UsuariosForm" property = "opcion" value="2" >
      <tr>
          <td class="S10d"><bean:message key="Usuarios.codigo" /></td>
          <td><html:text readonly="true" property="usu_codigo" name="UsuariosForm" size="2" maxlength="2" /></td>
      </tr>
      <tr>
          <td class="S10d"><bean:message key="Usuarios.carnet" /></td>
          <td><html:text property="usu_carnet" name="UsuariosForm" size="50" maxlength="50" onchange="javascript:this.value=this.value.toUpperCase();" /></td>
      ...
      <tr>
          <td align="right"><html:submit value="Modificar" styleClass="boton1" property="boton" onclick="operacion.value=2;opcion.value=2" />
          <td align="left"><html:submit value="Cancelar" styleClass="boton1" property="boton" onclick="operacion.value=2;opcion.value=9" />
      </tr>
   </logic:equal>
   <logic:equal name="UsuariosForm" property = "opcion" value="3" >
      ...
      <tr>
          <td class="S10d"><bean:message key="Usuarios.codfun" /></td>
          <html:text readonly="true" property="usu_codfun" name="UsuariosForm" size="30" maxlength="30" /></td>
      </tr>      
      <tr>
          <td align="right"><html:submit value="Eliminar" styleClass="boton1" property="boton" onclick="operacion.value=2;opcion.value=3" />
          <td align="left"><html:submit value="Cancelar" styleClass="boton1" property="boton" onclick="operacion.value=2;opcion.value=9" />
      </tr>
   </logic:equal>
</logic:equal>
