...
<logic:equal value="1" name="ActivosForm" property="operacion">
   ...
   <logic:equal name="ActivosForm" property = "opcion" value="1" >
      ...
      <table width="100%" align="center"  class="soloborde" bgcolor="#C1C1FF" border="1">
      <tr>
         <td class="S10d"><bean:message key="activos2.umanejo" /></td>
      ...
      <tr>
         <td class="S10d"><bean:message key="activos2.descripcion" /></td>
      ...
      <tr>
         <td class="S10d"><bean:message key="activos2.desadicional" /></td>
      ...
      <tr>
         <td class="S10d">*<bean:message key="activos2.proveedor" /></td>
         <td><html:text property="act_proveedor" name="ActivosForm" size="50" maxlength="50" onchange="javascript:this.value=this.value.toUpperCase();" /></td>
      </tr>            
      <tr>
         <td class="S10d"><bean:message key="activos2.accesorios" /></td>
         <td><html:text property="act_accesorios" name="ActivosForm" size="60" maxlength="60" onchange="javascript:this.value=this.value.toUpperCase();" /></td>
      </tr>
      </table>
      <table width="100%" align="center"  class="soloborde" bgcolor="#C1C1FF" border="1">      
      <tr>
         <td class="S10d"><bean:message key="activos2.marca" /></td>
      ...
      <tr>
         <td class="S10d"><bean:message key="activos2.modelo" /></td>
         <td><html:text property="act_modelo" name="ActivosForm" size="30" maxlength="30" onchange="javascript:this.value=this.value.toUpperCase();" /></td>
         <td class="S10d"><bean:message key="activos2.serie1" /></td>
         <td><html:text property="act_serie1" name="ActivosForm" size="30" maxlength="30" onchange="javascript:this.value=this.value.toUpperCase();" /></td>
      </tr>
      <tr>
         <td class="S10d"><bean:message key="activos2.serie2" /></td>
         <td><html:text property="act_serie2" name="ActivosForm" size="30" maxlength="30" onchange="javascript:this.value=this.value.toUpperCase();" /></td>
         <td class="S10d"><bean:message key="activos2.docreferencia" /></td>
         <td><html:text property="act_docreferencia" name="ActivosForm" size="30" maxlength="30" onchange="javascript:this.value=this.value.toUpperCase();" /></td>
      </tr>
      <tr>
         <td class="S10d"><bean:message key="activos2.fecreferencia" /></td>
         <td><html:text property="act_fecreferencia" name="ActivosForm" size="10" maxlength="10" /></td>
         <td class="S10d"><bean:message key="activos2.docrefotro" /></td>
         <td><html:text property="act_docrefotro" name="ActivosForm" size="60" maxlength="240" onchange="javascript:this.value=this.value.toUpperCase();" /></td>
      </tr>
      <tr>
         <td class="S10d"><bean:message key="activos2.placa" /></td>
         <td><html:text property="act_placa" name="ActivosForm" size="10" maxlength="10" onchange="javascript:this.value=this.value.toUpperCase();" /></td>
         <td class="S10d"><bean:message key="activos2.aniofabricacion" /></td>
         <td><html:text property="act_aniofabricacion" name="ActivosForm" size="4" maxlength="4" /></td>
      </tr>
      <tr>
         <td class="S10d"><bean:message key="activos2.color" /></td>
         ...
         <td class="S10d"><bean:message key="activos2.procedencia" /></td>
      ...
      <tr>
         <td class="S10d"><bean:message key="activos2.gobmunicipal" /></td>
         <td><html:text property="act_gobmunicipal" name="ActivosForm" size="30" maxlength="30" onchange="javascript:this.value=this.value.toUpperCase();" /></td>
      </tr>      
      <tr>
         <td class="S10d"><bean:message key="activos2.valcobol" /></td>
         <td><html:text property="act_valcobol" name="ActivosForm" size="13" maxlength="13" /></td>
         <td class="S10d"><bean:message key="activos2.ordencompra" /></td>
         <td><html:text property="act_ordencompra" name="ActivosForm" size="20" maxlength="20" /></td>
      </tr>
      <tr>
         <td class="S10d"><bean:message key="activos2.numfactura" /></td>
         <td><html:text property="act_numfactura" name="ActivosForm" size="12" maxlength="12" /></td>
         <td class="S10d"><bean:message key="activos2.numcomprobante" /></td>
         <td><html:text property="act_numcomprobante" name="ActivosForm" size="20" maxlength="20" /></td>
      </tr>
      <tr>
         <td class="S10d"><bean:message key="activos2.codanterior" /></td>
      ...
      <tr>
         <td class="S10d"><bean:message key="activos2.desestado" /></td>
