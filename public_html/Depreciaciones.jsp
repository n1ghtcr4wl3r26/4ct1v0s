...
<logic:equal value="1" name="DepreciacionesForm" property="operacion">
  <logic:equal value="1" name="DepreciacionesForm" property="opcion">
     <tr>
        <td class="S10d">Gestion</td>
        <td><html:text readonly="true" property="anio" name="DepreciacionesForm" size="10" maxlength="10" /></td>
     </tr>
     <tr>
     ...
     <tr>
        <td class="S10d"><bean:message key="depreciaciones.fecha" /></td>
        <td><html:text property="dpr_fecha" name="DepreciacionesForm" size="10" maxlength="10" /></td>
     </tr>
     <tr>
        <td align="center" colspan="2">
        <html:submit value="Generar" styleClass="boton1" property="boton" onclick="operacion.value=2;opcion.value=1" /></td>
    </tr>
  </logic:equal>
  <logic:equal value="2" name="DepreciacionesForm" property="opcion">
     <tr>
        <td class="S10d">Regional : </td>
        <td>
           <html:select name="DepreciacionesForm" property="dep_codreg" disabled="false">
