...
<logic:equal value="1" name="ActivosForm" property="operacion">
   <logic:equal name="ActivosForm" property = "opcion" value="4" >
      ...
      <tr>
         ...
         <td class="S10d"><bean:message key="activos2.tipcam" /></td>
         <td><html:text readonly="true" property="act_tipcam" name="ActivosForm" size="11" maxlength="11" /></td>
      </tr>
      <tr>
         <td class="S10d"><bean:message key="activos2.tipufv" /></td>
     ...
     <table width="100%" align="center"  class="soloborde" bgcolor="#C1C1FF" border="1">
      ...
      <tr>
         ...
         <td><html:text readonly="true" property="act_serie2" name="ActivosForm" size="30" maxlength="30" /></td>
         <td class="S10d"><bean:message key="activos2.docreferencia" /></td>
         <td><html:text readonly="true" property="act_docreferencia" name="ActivosForm" size="30" maxlength="30" /></td>
      </tr>
      <tr>
         <td class="S10d"><bean:message key="activos2.fecreferencia" /></td>
         <td><html:text readonly="true" property="act_fecreferencia" name="ActivosForm" size="10" maxlength="10" /></td>
         <td class="S10d"><bean:message key="activos2.docrefotro" /></td>
         <td><html:text readonly="true" property="act_docrefotro" name="ActivosForm" size="60" maxlength="240" /></td>
      </tr>
      <tr>
         <td class="S10d"><bean:message key="activos2.placa" /></td>
         <td><html:text readonly="true" property="act_placa" name="ActivosForm" size="10" maxlength="10" /></td>
         <td class="S10d"><bean:message key="activos2.aniofabricacion" /></td>
         <td><html:text readonly="true" property="act_aniofabricacion" name="ActivosForm" size="10" maxlength="10" /></td>
      </tr>
      <tr>
