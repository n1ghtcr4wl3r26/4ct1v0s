...
<logic:equal value="1" name="ActivosForm" property="operacion">
   <logic:equal name="ActivosForm" property = "opcion" value="4" >
      ...
      <tr>
         ...
         <td class="S10d"><bean:message key="activos1.tipcam" /></td>
         <td><html:text readonly="true" property="act_tipcam" name="ActivosForm" size="11" maxlength="11" /></td>
      </tr>
      <tr>
         <td class="S10d"><bean:message key="activos1.tipufv" /></td>
     ...
     <table width="100%" align="center"  class="soloborde" bgcolor="#C1C1FF" border="1">
      ...
      <tr>
         ...
         <td>
            <html:text readonly="tru" property="act_proveedor" name="ActivosForm" size="50" maxlength="50" />
         </td>
      </tr>            
      <tr>
         <td class="S10d"><bean:message key="activos1.accesorios" /></td>
         <td><html:text readonly="true" property="act_accesorios" name="ActivosForm" size="60" maxlength="60" /></td>
      </tr>
      </table>
      <table width="100%" align="center"  class="soloborde" bgcolor="#C1C1FF" border="1">      
      <tr>
